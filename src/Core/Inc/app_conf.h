...
#define CFG_FAST_CONN_ADV_INTERVAL_MAX    (0x0280)  /**< 100ms */
 ...
 */
#define CFG_GAP_DEVICE_NAME             "SiliconRemote"
 ...
 */
#define CFG_BLE_NUM_GATT_ATTRIBUTES 23
