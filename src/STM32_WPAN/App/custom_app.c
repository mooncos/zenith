...
/* Private function prototypes -----------------------------------------------*/
  /* SiliconRemoteSvc */
static void Custom_Siliconremoteramp0_Update_Char(void) __attribute__((unused));
static void Custom_Siliconremoteramp0_Send_Notification(void) __attribute__((unused));
...
{
  Custom_STM_App_Update_Char(CUSTOM_STM_SILICONREMOTERAMP0, (uint8_t *)UpdateCharData);
...
void Custom_Siliconremoteramp0_Send_Notification(void) /* Property Notification */
 {
  ...
  {
    Custom_STM_App_Update_Char(CUSTOM_STM_SILICONREMOTERAMP0, (uint8_t *)NotifyCharData);
...
void doSend(void) {
	...
	if (Custom_App_Context.Siliconremoteramp0_Notification_Status) {
		if (!isEmpty(&bleQueue)) {
			status = Custom_STM_App_Update_Char(CUSTOM_STM_SILICONREMOTERAMP0, front(&bleQueue));
